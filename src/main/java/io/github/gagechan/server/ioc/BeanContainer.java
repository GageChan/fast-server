package io.github.gagechan.server.ioc;
...
import io.github.gagechan.server.exception.InitBeanException;
import io.github.gagechan.server.exception.NoBeanContainerException;
import io.github.gagechan.server.exception.NoSuchBeanException;
...
public abstract class BeanContainer {
    ...
    private static final String                  FAST_PACKAGE = "io.github.gagechan.server";
