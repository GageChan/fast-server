...
public class HttpResponse {
    ...
    */
     ...
     * @param html the html
    */
    public void renderText(String html) {
        render(CONTENT_TYPE_HTML, html);
    }
    ...
    * @param data the data
    */
    public void render(String contentType, String data) {
    ...
    *
    * @param htmlName the path
    * @return the http response
    */
    public HttpResponse renderHtml(String htmlName) {
        TemplateRenderEngine engine = BeanContainer.getBean(TemplateRenderEngine.class);
        String html = engine.render(request.getAttributes(), htmlName);
        renderText(html);
        return this;
    }
